...
@section('content')
    <form method="POST" action="{{ route('register') }}">
        ...
        <div>
            ...
            {{-- エラーメッセージエリア --}}
                <p>error</p>
            <select type="text" class="form-control" name="area" id="pref">                          
        ...
        <div>
            ...
            <input type="text" placeholder="例） 〇〇マンション101号室" id="mansion">
        </div>
        <hr>
        ...
        {{-- パスワード変更確認 --}}
         <div class="flex">
            <fieldset>
                ...
                <div class="flex-1">
                    <input type="radio" id="change" name="password" value="1"/>
                    <label for="change">変更する</label>
                </div>
                <div class="flex-1">
                    <input type="radio" id="not_change" name="password" value="0" checked/>
        ...
        <div class="flex">
            <fieldset>
                ...
                <div class="flex-1">
                    <input type="radio" id="accept" name="mailmagazine" value="1"/>
                    <label for="accept">希望する</label>
                </div>
                <div class="flex-1">
                    <input type="radio" id="not_accept" name="mailmagazine" value="0" checked/>
