  ...
  <div class="flex justify-center">
    <div class="flex flex-wrap items-end gap-3">
      ...
      <div class="flex flex-col">
        ...
        <input type="number" name="min_price" class="px-2 py-1 border rounded w-[80px] text-sm" placeholder="1000">
      </div>
      ...
      <div class="flex flex-col">
        ...
        <input type="number" name="max_price" class="px-2 py-1 border rounded w-[80px] text-sm" placeholder="3000">
      </div>
