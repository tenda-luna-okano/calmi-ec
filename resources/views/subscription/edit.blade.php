...
<body>
    ...
    <div class="field">
        ...
        <div style="width:50%; height:200px">
            <img id="LightNight" src="{{ asset('img/LightNight.png') }}" alt="" style="height:90%;">
        </div>
    </div>
    </center>
    ...
    <div class="field">
        <div>
            <img id="DeepNight" src="{{ asset('img/DeepNight.png') }}" alt="" style="width:80%;"><br>
            <button class="change_subscription" style="background-color:#d0b49f; height:40px; width:60%; color:white;">変更する</button>
        </div>
        <div>
            <img id="PremiunNight" src="{{ asset('img/PremiumNight.png') }}" alt="" style="width:80%;"><br>
            <button class="change_subscription" style="background-color:#d0b49f; height:40px; width:60%; color:white;">変更する</button>
        </div>
    </div>
    </center>
